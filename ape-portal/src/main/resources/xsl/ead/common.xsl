...
<xsl:stylesheet version="2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
            ...
            <xsl:when test="./@authfilenumber">
                <xsl:choose>
                    <xsl:when test="ape:linkedEacCpf(./@authfilenumber) = 'indexed'">
                        <xsl:call-template name="createEacLink">
                        ...
                        <xsl:if test="number($maxNumber) eq 0 or $linkPosition &lt;= number($maxNumber)">
                            ...
                            <xsl:choose>
                                        ...
                                        <a href="{$href}" target="_blank">
                                            <xsl:choose>
                                                <xsl:when test="$linkPosition &lt;= 5">
                                                    <img src="{$thumbnailHref}" alt="{$dao.title}" title="{$dao.title}"/>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <img data-src="{$thumbnailHref}" alt="{$dao.title}" title="{$dao.title}"/>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                            <span>
                                                <xsl:value-of select="$dao.title" />
                                ...
                                <xsl:otherwise>
                                    <div class="dao">
                                        <span>
                                            <xsl:value-of select="ape:resource('eadcontent.dao.more.lowerlevel')" />
                                        </span>
                                    </div>
                                </xsl:otherwise>
                            </xsl:choose>
                ...
                <xsl:if test="not($isPreview) and not($isChild)">
                    <div class="linkButton" id="moreDaosButton">
                        <a href="javascript:void(0)">
                            <xsl:value-of select="ape:resource('eadcontent.dao.more')" /> (<span></span>)</a>
                    </div>
                </xsl:if>
            </div>
        </div>
            ...
            <xsl:for-each select="ead:controlaccess">
                ...
                <xsl:if test="ead:subject">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.subject')"/>:</b> 
                ...
                <xsl:if test="ead:geogname">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.geogname')"/>:</b>
                ...
                <xsl:if test="ead:persname">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.persname')"/>:</b>
                ...
                <xsl:if test="ead:famname">
                    <div class="pControlacces">
                        <b> 
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.famname')"/>:</b>
                ...
                <xsl:if test="ead:corpname">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.corpname')"/>:</b>
                ...
                <xsl:if test="ead:name"> 
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.name')"/>:</b>
                ...
                <xsl:if test="ead:occupation">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.occupation')"/>:</b> 
                ...
                <xsl:if test="ead:function">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.function')"/>:</b> 
                ...
                <xsl:if test="ead:genreform">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.genreform')"/>:</b>
                        <div>
                            <xsl:for-each select="ead:genreform">
                                <br>	
                                    <xsl:value-of select="ape:highlight(., 'other')" disable-output-escaping="yes" />
                ...
                <xsl:if test="ead:title">
                    <div class="pControlacces">
                        <b>
                            <xsl:value-of select="ape:resource('eadcontent.controlaccess.title')"/>:</b> 
                        ...
                        <p>
                            ...
                            <xsl:choose>
                                <xsl:when test="./parent::node()/@xlink:title">
                                    <a href="{$href}" target="_blank">
                                        <xsl:value-of select="./parent::node()/@xlink:title"></xsl:value-of>
                                    </a>
                                </xsl:when>
                                <xsl:otherwise>
                                    <a href="{$href}" target="_blank">
            ...
            <xsl:otherwise> 
                <p>
                    ...
                    <xsl:choose>
                        <xsl:when test="./@xlink:title">
                            <a href="{$href}" target="_blank">
                                <xsl:value-of select="./@xlink:title"></xsl:value-of>
                            </a>
                        </xsl:when>
                        <xsl:otherwise>
                            <a href="{$href}" target="_blank">
    ...
    <xsl:template name="createEacLink">
