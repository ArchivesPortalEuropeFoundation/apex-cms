...
public final class AnalyzeLogger {
	...
	private static final Logger SIMPLE_SEARCH_ANALYZE_LOGGER = Logger
			.getLogger("SIMPLE_SEARCH_ANALYZE");
	private static final Logger ADVANCED_SEARCH_ANALYZE_LOGGER = Logger
			.getLogger("ADVANCED_SEARCH_ANALYZE");
	private static final Logger ADVANCED_SEARCH_LIST_LOGGER = Logger
			.getLogger("ADVANCED_SEARCH_LIST_ANALYZE");
	private static final Logger ADVANCED_SEARCH_CONTEXT_LOGGER = Logger
			.getLogger("ADVANCED_SEARCH_CONTEXT_ANALYZE");
	private static final Logger PREVIEW_SECOND_DISPLAY_ANALYZE_LOGGER = Logger
			.getLogger("PREVIEW_SECOND_DISPLAY_ANALYZE");
	private static final Logger AL_ANALYZE_LOGGER = Logger
			.getLogger("AL_ANALYZE");

	public static void logAlTree(AlType parentType, TreeType treeType,
			Integer start) {
	...
	public static void logAdvancedSearch(String userId,
		...
		if (advancedSearch.isAdvanced()) {
			if (ADVANCED_SEARCH_ANALYZE_LOGGER.isDebugEnabled()) {
				...
				logLine += countList(solrQueryParameters.getOrParameters().get(
						SolrFields.COUNTRY_ID))
						+ ";";
				logLine += countList(solrQueryParameters.getOrParameters().get(
						SolrFields.AI_ID))
						+ ";";
			...
			logSimpleSearch(userId, advancedSearch);
		}
	}

	public static void logUpdateAdvancedSearchContext(String userId,
			TreeAdvancedSearch advancedSearch,
			SolrQueryParameters solrQueryParameters) {
	...
	public static void logUpdateAdvancedSearchList(String userId,
			AdvancedSearch advancedSearch,
			SolrQueryParameters solrQueryParameters) {
	...
	private static void logSimpleSearch(String userId,
			AdvancedSearch advancedSearch) {
