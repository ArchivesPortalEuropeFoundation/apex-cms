...
public class SavedSearchService {
    ...
    public void saveSearch(Long eadSavedSearchId, Long liferayUserId, EadSearch eadSearch) {
        ...
        eadSavedSearch.setRefinementType(removeEmptyString(eadSearch.getRecordType()));
        eadSavedSearch.setRefinementLevel(removeEmptyString(eadSearch.getLevelName()));
        eadSavedSearch.setRefinementDao(removeEmptyString(eadSearch.getDao()));
        eadSavedSearch.setRefinementRoledao(removeEmptyString(eadSearch.getDaoType()));
    ...
    public EadSearch convert(EadSavedSearch eadSavedSearch, EadSearch eadSearch) {
        if (eadSavedSearch != null) {
            ...
            if (!eadSavedSearch.isTemplate()) {
                ...
                eadSearch.setRecordType(eadSavedSearch.getRefinementType());
                eadSearch.setLevelName(eadSavedSearch.getRefinementLevel());
                ...
                eadSearch.setDaoType(eadSavedSearch.getRefinementRoledao());
...
//
//			}		
            List<String> types = eadSearch.getRecordTypeList();
            if (types != null) {
            ...
            List<String> levels = eadSearch.getLevelNameList();
            if (levels != null) {
            ...
            List<String> roledaos = eadSearch.getDaoTypeList();
            if (roledaos != null) {
