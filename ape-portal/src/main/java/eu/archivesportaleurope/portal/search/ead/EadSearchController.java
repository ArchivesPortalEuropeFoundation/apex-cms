...
//						modelAndView.getModelMap().addAttribute("eadSearch", eadSearch);
    ...
    protected SolrQueryParameters handleSearchParametersForListUpdate(PortletRequest portletRequest, EadSearch eadSearch) {
        ...
        SearchUtil.addRefinement(solrQueryParameters, FacetType.TYPE, eadSearch.getRecordTypeList());
        ...
        SearchUtil.addRefinement(solrQueryParameters, FacetType.ROLEDAO, eadSearch.getDaoTypeList());
//		SearchUtil.addRefinement(solrQueryParameters, FacetType.FOND, eadSearch.getFondList()); //ToDo: Merge
        SearchUtil.addRefinement(solrQueryParameters, FacetType.LEVEL, eadSearch.getLevelNameList());
        return solrQueryParameters;
    }
