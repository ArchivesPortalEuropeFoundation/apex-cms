							...
							<tbody>
								<c:if test="${hasHoldingsGuides}">
									<tr>
										<td colspan="2">
											<div>
												<a href="${contentUrl}/${archivalInstitution.repositorycode}/hg"><fmt:message
								...
								<c:if test="${hasFindingAids}">
									<tr>
										<td colspan="2">
											<div>
												<a href="${contentUrl}/${archivalInstitution.repositorycode}/fa"><fmt:message
								...
								<c:if test="${hasSourceGuides}">
									<tr>
										<td colspan="2">
											<div>
												<a href="${contentUrl}/${archivalInstitution.repositorycode}/sg"><fmt:message
