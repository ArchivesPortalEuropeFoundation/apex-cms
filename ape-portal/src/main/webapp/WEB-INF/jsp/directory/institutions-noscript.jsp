...
<div id="directoryPortlet">
	<div class="mobile">
		...
		<c:forEach var="archivalInstitutionUnit"
			items="${archivalInstitutionUnits}">
			<c:choose>
				...
				<c:otherwise>
					<c:set var="url"
						value="${aiCodeUrl}/${archivalInstitutionUnit.repoCode}" />
				</c:otherwise>
			</c:choose>
			<div class="child">
				<a href="${url}">${archivalInstitutionUnit.ainame}</a>
			</div>
