...
<div id="viewFullFond" class="linkButton">
	<portal:eadPersistentLink var="url"  repoCode="${aiRepoCode}" xmlTypeName="${xmlType.resourceName}" eadid="${eadid}" clevel="${c}" searchFieldsSelectionId="${element}" searchTerms="${term}"/>
