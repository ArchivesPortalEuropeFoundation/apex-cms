...
<div id="content">	
	<div id="realcontent">
	<portal:ead type="frontpage-ead3" xml="${eadContent.xml}" searchTerms="${term}"  searchFieldsSelectionId="${element}"  aiId="${aiId}" preview="true" xmlTypeName="${xmlType.resourceName}"/>
	</div>
</div>
