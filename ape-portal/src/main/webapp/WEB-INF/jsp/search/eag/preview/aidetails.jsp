...
<a href="https://maps.google.com/maps?daddr=${coordinates.lat},${coordinates.lon}" target="_blank">Routebeschrijving<span class="icon_new_window">&nbsp;</span></a>
</div>
...
<a href="${url}" target="_blank">View details<span class="icon_new_window">&nbsp;</span></a>
</div>