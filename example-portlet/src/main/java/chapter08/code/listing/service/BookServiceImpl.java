...
public class BookServiceImpl implements BookService {
	...
	public BookServiceImpl() {
		books.add(new Book("AspectJ in Action, Second Edition", "Ramnivas Laddad", "1933988053"));
		books.add(new Book("ActiveMQ in Action", "Bruce Snyder, Dejan Bosanac, and Rob Davies", "1933988940"));
		books.add(new Book("Hadoop in Action", "Chuck Lam","9781935182191"));
		books.add(new Book("JUnit in Action, Second Edition", "Petar Tahchiev, Felipe Leme, Vincent Massol, and Gary Gregory","9781935182023"));
	}
	...
	public boolean isUniqueISBN(String isbnNumber) {
