<div class="ape-pagelayouts" id="main-content" role="main">
	...
	<div class="portlet-layout">
		<div class="aui-w40 portlet-column portlet-column-first" id="column-3">
			$processor.processColumn("column-3", "portlet-column-content portlet-column-content-first")
		</div>
		<div class="aui-w60 portlet-column portlet-column-last" id="column-4">
