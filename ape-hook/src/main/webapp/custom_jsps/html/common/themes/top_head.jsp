...
<c:otherwise>
<link class="lfr-css-file" href="<%= HtmlUtil.escapeAttribute(PortalUtil.getStaticResourceURL(request, themeDisplay.getPathThemeCss() + "/main-public.css")) %>" rel="stylesheet" type="text/css" />
</c:otherwise>
</c:choose>
